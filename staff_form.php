            ...
            <div class="login-form2">
                ...
                <form action="" method="post" id="formRegisterStaff">
                    ...
                    <div class="form-group row">
                        <label for="staffID" class="col-sm-4 col-form-label">Staff ID / ID Staff</label>
                        <div class="col-sm-8">
                          <input type="text"  name="staffID" class="form-control form-control-sm rounded-0" id="staffID" required>
                        </div>
                    </div>
                    <div class="form-group row">
